...
#define rwPLUGIN_ID           rwID_UVANIMPLUGIN

#define rwPLUGIN_ERRFUNC       _rwdb_CriterionUVAnim
#define rwPLUGIN_ERRENUM      e_rwdb_CriterionUVAnim
#define rwPLUGIN_ERRENUMLAST  e_rwdb_CriterionUVAnimLAST
