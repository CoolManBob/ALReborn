...
extern long         rpHANIMStackDepth;

#define RWDEBUGSTACKDEPTH rpHANIMStackDepth
...
#define rwPLUGIN_ID      rwID_HANIMPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionHANIM
#define rwPLUGIN_ERRENUM e_rwdb_CriterionHANIM
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionHANIMLAST
