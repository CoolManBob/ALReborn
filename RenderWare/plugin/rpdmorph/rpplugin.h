...
extern long rpDMorphStackDepth;
#define RWDEBUGSTACKDEPTH rpDMorphStackDepth
...
#define rwPLUGIN_ID           rwID_DMORPHPLUGIN

#define rwPLUGIN_ERRFUNC       _rwdb_CriterionDMorph
#define rwPLUGIN_ERRENUM      e_rwdb_CriterionDMorph
#define rwPLUGIN_ERRENUMLAST  e_rwdb_CriterionDMorphLAST
