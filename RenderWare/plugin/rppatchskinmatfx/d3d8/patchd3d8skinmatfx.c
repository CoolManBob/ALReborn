...
/*****************************************************************************
 _rxD3D8PatchMatFXPipelineNodeInitFn
 ...
 */
static RwBool
D3D8PatchMatFXPipelineNodeInitFn( RxPipelineNode *self )
{
    RWFUNCTION(RWSTRING("D3D8PatchMatFXPipelineNodeInitFn"));
    ...
    if (self)
    {
         ...
         */
        data->renderCallback = _rwD3D8AtomicMatFXRenderCallback;
...
/*****************************************************************************
 NodeDefinitionGetD3D8PatchMatFXAtomicInstance
...
*/
static RxNodeDefinition   *
NodeDefinitionGetD3D8PatchMatFXAtomicInstance(void)
{
    static RwChar _PatchAtomic_csl[] = "PatchMatFXAtomic.csl";
    ...
    static RxNodeDefinition nodeD3D8PatchAtomic = { /* */
        ...
        {                                           /* Nodemethods */
            ...
            NULL,                                   /* +-- nodeinit */
            NULL,                                   /* +-- nodeterm */
            D3D8PatchMatFXPipelineNodeInitFn,       /* +-- pipelinenodeinit */
            NULL,                                   /* +-- pipelineNodeTerm */
            NULL,                                   /* +-- pipelineNodeConfig */
            NULL,                                   /* +-- configMsgHandler */
        },
    ...
    RWFUNCTION(RWSTRING("NodeDefinitionGetD3D8PatchMatFXAtomicInstance"));
...
/*****************************************************************************
 NodeDefinitionGetD3D8PatchSkinMatFXAtomicInstance

 Returns a pointer to a node to instance a skin patch matfx atomic in a form
 suitable for rendering by a D3D8 pipeline.
 ...
 Returns a pointer to node for skin patch matfx faceting custom pipelines on success,
 or NULL otherwise
*/
static RxNodeDefinition   *
NodeDefinitionGetD3D8PatchSkinMatFXAtomicInstance(void)
{
    static RwChar _PatchAtomic_csl[] = "PatchSkinMatFXAtomic.csl";
    ...
    RWFUNCTION(RWSTRING("NodeDefinitionGetD3D8PatchSkinMatFXAtomicInstance"));
...
_rpPatchPipelinesAttach(RpAtomic *atomic, RpPatchType type)
{
    ...
    if(type == rpNAPATCHTYPE)
    {
        if (matfx)
        {
            if (skinned)
            {
                pipeline = _rpPatchGlobals.platform.pipelines[rpPATCHD3D8PIPELINESKINMATFX];
            }
            else
            {
                pipeline = _rpPatchGlobals.platform.pipelines[rpPATCHD3D8PIPELINEMATFX];
            }
        }
        else
        {
