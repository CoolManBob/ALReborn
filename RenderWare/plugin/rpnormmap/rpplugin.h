...
extern long rpNormMapStackDepth;
#define RWDEBUGSTACKDEPTH rpNormMapStackDepth
...
#define rwPLUGIN_ID            rwID_NORMMAPPLUGIN
#define rwPLUGIN_ERRFUNC      _rwdb_CriterionNORMMAP
#define rwPLUGIN_ERRENUM     e_rwdb_CriterionNORMMAP
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionNORMMAPLAST
