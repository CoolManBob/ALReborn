...
_rpPatchPipelinesCreate(RwUInt32 pipes)
{
    ...
    if((pipes & rpPATCHPIPELINESKINNED) && (pipes & rpPATCHPIPELINEMATFX))
    {
        pipe = RxPipelineCreate();
        RWASSERT(NULL != pipe);
        ...
        pipe->pluginData = rpPATCHTYPESKINMATFX;
         ...
         _rpPatchPipeline(rpPATCHNULLPIPELINESKINMATFX) = pipe;
        RWASSERT(NULL != _rpPatchPipeline(rpPATCHNULLPIPELINESKINMATFX));
   }
    ...
    else
    {
        ...
        switch(type)
        {
            ...
            case rpPATCHTYPESKINMATFX:
                iPipeline = rpPATCHNULLPIPELINESKINMATFX;
                break;
            default:
