 ...
 *
 */
//@{ 20050513 DDonSS : Threadsafe 처리.. 외부 Lock함수 이용을 위한 인자 추가..
RwBool
...
#if ( ( defined WIN32 ) && ( ( defined USE_EXTERNAL_LOCK_FUNCTION_WITH_FILEINFO ) || ( defined USE_EXTERNAL_LOCK_FUNCTION ) ) )
	if ( NULL != lockFuncs )
	{
...
#endif //  ( ( defined WIN32 ) && ( ( defined USE_EXTERNAL_LOCK_FUNCTION_WITH_FILEINFO ) || ( defined USE_EXTERNAL_LOCK_FUNCTION ) ) )
//@} DDonSS
