                        ...
                        RwInt32 *npDepth, RwInt32 *npFormat)
{
 ...
 RWSTRING("Image: width=%d height=%d pixel depth=%d palette depth=%d palettised=%s\n")
 RWSTRING("Raster: width=%d height=%d pixel depth=%d palette depth=%d palettised=%s ")
                         RWSTRING("format=0x%x"),
