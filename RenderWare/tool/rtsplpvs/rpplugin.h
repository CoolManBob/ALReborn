...
#define rwPLUGIN_ID      rwID_SPLINEPVSPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionSplinePVS
#define rwPLUGIN_ERRENUM e_rwdb_CriterionSplinePVS
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionSplinePVSLAST
