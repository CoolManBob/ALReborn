...
png_write_gAMA(png_structp png_ptr, double file_gamma)
{
   ...
   igamma = (png_uint_32)
             IntFromFloatMacro((float)(file_gamma * 100000.0 + 0.5));
   ...
   double blue_x, double blue_y)
{
   ...
   itemp = (png_uint_32)
                    IntFromFloatMacro((float)(white_x * 100000.0 + 0.5));
   png_save_uint_32(buf, itemp);
   itemp = (png_uint_32)
                    IntFromFloatMacro((float)(white_y * 100000.0 + 0.5));
   ...
   itemp = (png_uint_32)
       IntFromFloatMacro((float)(red_x * 100000.0 + 0.5));
   png_save_uint_32(buf + 8, itemp);
   itemp = (png_uint_32)
       IntFromFloatMacro((float)(red_y * 100000.0 + 0.5));
   ...
   itemp = (png_uint_32)
       IntFromFloatMacro((float)(green_x * 100000.0 + 0.5));
   png_save_uint_32(buf + 16, itemp);
   itemp = (png_uint_32)
       IntFromFloatMacro((float)(green_y * 100000.0 + 0.5));
   ...
   itemp = (png_uint_32)
       IntFromFloatMacro((float)(blue_x * 100000.0 + 0.5));
   png_save_uint_32(buf + 24, itemp);
   itemp = (png_uint_32)
       IntFromFloatMacro((float)(blue_y * 100000.0 + 0.5));
