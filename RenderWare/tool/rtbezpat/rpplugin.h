...
#define rwPLUGIN_ID      rwID_BEZPATCHPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionBEZPATCH
#define rwPLUGIN_ERRENUM e_rwdb_CriterionBEZPATCH
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionBEZPATCHLAST
