...
#define rwPLUGIN_ID      rwID_PICKPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionPick
#define rwPLUGIN_ERRENUM e_rwdb_CriterionPick
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionPickLAST
