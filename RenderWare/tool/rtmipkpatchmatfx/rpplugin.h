...
#define rwPLUGIN_ID      rwID_MIPMAPKPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionMipmapK
#define rwPLUGIN_ERRENUM e_rwdb_CriterionMipmapK
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionMipmapKLAST
