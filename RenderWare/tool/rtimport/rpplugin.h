...
#define rwPLUGIN_ID      rwID_NOHSWORLDPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionNoHSWorld
#define rwPLUGIN_ERRENUM e_rwdb_CriterionNoHSWorld
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionNoHSWorldLAST
