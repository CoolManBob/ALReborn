...
#define rwPLUGIN_ID      rwID_CHARSEPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionCharset
#define rwPLUGIN_ERRENUM e_rwdb_CriterionCharset
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionCharsetLAST
