...
#define rwPLUGIN_ID      rwID_TileRendPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionTileRend
#define rwPLUGIN_ERRENUM e_rwdb_CriterionTileRend
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionTileRendLAST
