...
#define rwPLUGIN_ID      rwID_GEOMCONDPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionGeomCond
#define rwPLUGIN_ERRENUM e_rwdb_CriterionGeomCond
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionGeomCondLAST
