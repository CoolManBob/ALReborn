...
#define rwPLUGIN_ID      rwID_BMPIMAGEPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionBMP
#define rwPLUGIN_ERRENUM e_rwdb_CriterionBMP
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionBMPLAST
