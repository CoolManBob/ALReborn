...
#define rwPLUGIN_ID      rwID_CMPKEYTOOLKIT
#define rwPLUGIN_ERRFUNC _rwdb_CriterionCmpKey
#define rwPLUGIN_ERRENUM e_rwdb_CriterionCmpKey
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionCmpKeyLAST
