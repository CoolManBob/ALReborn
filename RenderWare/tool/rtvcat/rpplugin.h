...
#define rwPLUGIN_ID      rwID_VCATPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionVextexCacheStrip
#define rwPLUGIN_ERRENUM e_rwdb_CriterionVextexCacheStrip
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionVextexCacheStripLAST
