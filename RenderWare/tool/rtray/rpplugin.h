...
#define rwPLUGIN_ID      rwID_RAYPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionRay
#define rwPLUGIN_ERRENUM e_rwdb_CriterionRay
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionRayLAST
