...
{
#endif                          /* __cplusplus */
extern long rtSlerpStackDepth;
#ifdef    __cplusplus
}
#endif                          /* __cplusplus */
#define RWDEBUGSTACKDEPTH rtSlerpStackDepth
...
#define rwPLUGIN_ID      rwID_SLERPPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionSlerp
#define rwPLUGIN_ERRENUM e_rwdb_CriterionSlerp
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionSlerpLAST
