...
#define rwPLUGIN_ID      rwID_INTSECPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionIntsec
#define rwPLUGIN_ERRENUM e_rwdb_CriterionIntsec
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionIntsecLAST
