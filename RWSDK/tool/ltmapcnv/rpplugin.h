...
{
#endif                          /* __cplusplus */
extern long RtLtMapConverStackDepth;
#ifdef    __cplusplus
}
#endif                          /* __cplusplus */
#define RWDEBUGSTACKDEPTH RtLtMapConverStackDepth
 ...
 * mechanism
 */
#define rwPLUGIN_ID      rwID_LTMAPCNVTOOLKIT
#define rwPLUGIN_ERRFUNC _rwdb_CriterionLtMapCnv
#define rwPLUGIN_ERRENUM e_rwdb_CriterionLtMapCnv
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionLtMapCnvLAST
