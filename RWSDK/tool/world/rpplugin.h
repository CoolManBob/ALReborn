...
#define rwPLUGIN_ID      rwID_TLWORLDPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionTlWorld
#define rwPLUGIN_ERRENUM e_rwdb_CriterionTlWorld
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionTlWorldLAST
