/* $Header: //RenderWare/RW37Active/rwsdk/tool/tiff/libtiff/tiffcomp.h#1 $ */
...
/* __MWERKS__ appears to be meant to read as "Macs with CodeWarrior" */
#if (defined(__MWERKS__) && defined(__MACOS__)) || defined(THINK_C)
#include <unix.h>
#include <math.h>
#endif
...
#if defined(__PPCC__) || defined(__SC__) || defined(__MRC__) || (defined(EPPC) && !defined(__SN__))
#include <types.h>
#elif !(defined(__MWERKS__) && defined(__MACOS__)) && !defined(THINK_C) && !defined(__acornriscos) && !defined(applec)
#include <sys/types.h>
#endif
 ...
 */
#if (defined(__MWERKS__) && defined(__MACOS__)) || defined(THINK_C) || defined(__PPCC__) || defined(__SC__) || defined(__MRC__)
#include <stdlib.h>
#define	BSDTYPES
...
/* this at least makes the rest of the tiff libs compile,
despite begin a rather stupid thing to do. */
#define GLOBALDATA(TYPE,NAME)	extern TYPE NAME
