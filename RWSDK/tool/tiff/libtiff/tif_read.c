/* $Header: //RenderWare/RW37Active/rwsdk/tool/tiff/libtiff/tif_read.c#1 $ */
...
{
    RWFUNCTION(RWSTRING("_TIFFSwab16BitData"));
    (void) tif;
...
{
    RWFUNCTION(RWSTRING("_TIFFSwab32BitData"));
    (void) tif;
...
{
    RWFUNCTION(RWSTRING("_TIFFSwab64BitData"));
    (void) tif;
    RWASSERT((cc & 7) == 0);
