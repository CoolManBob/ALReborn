...
#define rwPLUGIN_ID      rwID_TIFFIMAGEPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionTIFF
#define rwPLUGIN_ERRENUM e_rwdb_CriterionTIFF
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionTIFFLAST
