...
#define rwPLUGIN_ID      rwID_WINGPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionWing
#define rwPLUGIN_ERRENUM e_rwdb_CriterionWing
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionWingLAST
