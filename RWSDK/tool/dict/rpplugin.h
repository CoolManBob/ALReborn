...
#define rwPLUGIN_ID             rwID_DICTTOOLKIT
#define rwPLUGIN_ERRFUNC        _rwdb_CriterionDICT
#define rwPLUGIN_ERRENUM        e_rwdb_CriterionDICT
#define rwPLUGIN_ERRENUMLAST    e_rwdb_CriterionDICTLAST
