...
#define rwPLUGIN_ID      rwID_PNGIMAGEPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionPNG
#define rwPLUGIN_ERRENUM e_rwdb_CriterionPNG
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionPNGLAST
