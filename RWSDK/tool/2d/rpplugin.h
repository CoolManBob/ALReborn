...
#define rwPLUGIN_ID      rwID_2DPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_Criterion2D
#define rwPLUGIN_ERRENUM e_rwdb_Criterion2D
#define rwPLUGIN_ERRENUMLAST e_rwdb_Criterion2DLAST
