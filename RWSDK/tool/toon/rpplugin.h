...
#define rwPLUGIN_ID             rwID_TOONTOOLKIT
#define rwPLUGIN_ERRFUNC        _rwdb_CriterionTOC
#define rwPLUGIN_ERRENUM        e_rwdb_CriterionTOC
#define rwPLUGIN_ERRENUMLAST    e_rwdb_CriterionTOCLAST
