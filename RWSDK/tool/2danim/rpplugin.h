...
#define rwPLUGIN_ID      rwID_2DANIM
#define rwPLUGIN_ERRFUNC _rwdb_Criterion2DAnim
#define rwPLUGIN_ERRENUM e_rwdb_Criterion2DAnim
#define rwPLUGIN_ERRENUMLAST e_rwdb_Criterion2DAnimLAST
