...
#define rwPLUGIN_ID      rwID_ANIMTOOLKIT
#define rwPLUGIN_ERRFUNC _rwdb_CriterionAnim
#define rwPLUGIN_ERRENUM e_rwdb_CriterionAnim
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionAnimLAST
