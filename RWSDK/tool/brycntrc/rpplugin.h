...
{
#endif                          /* __cplusplus */
extern long rtBarycentricStackDepth;
#ifdef    __cplusplus
}
#endif                          /* __cplusplus */
#define RWDEBUGSTACKDEPTH rtBarycentricStackDepth
...
#define rwPLUGIN_ID      rwID_BARYCENTRIC
#define rwPLUGIN_ERRFUNC _rwdb_CriterionBary
#define rwPLUGIN_ERRENUM e_rwdb_CriterionBary
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionBaryLAST
