...
extern long _rpLtMapStackDepth;
#define RWDEBUGSTACKDEPTH _rpLtMapStackDepth
...
#define rwPLUGIN_ERRFUNC      _rwdb_CriterionLTMAP
#define rwPLUGIN_ERRENUM     e_rwdb_CriterionLTMAP
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionLTMAPLAST
