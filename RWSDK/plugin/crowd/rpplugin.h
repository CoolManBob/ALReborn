...
extern long rpCrowdStackDepth;
#define RWDEBUGSTACKDEPTH rpCrowdStackDepth
...
#define rwPLUGIN_ID            rwID_CROWDPPPLUGIN
#define rwPLUGIN_ERRFUNC      _rwdb_CriterionCROWDPP
#define rwPLUGIN_ERRENUM     e_rwdb_CriterionCROWDPP
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionCROWDPPLAST
