...
#define RWDEBUGSTACKDEPTH rpPVSStackDepth
...
#define rwPLUGIN_ID      rwID_GPVSPLUGIN

#define rwPLUGIN_ERRFUNC _rwdb_CriterionGPVS
#define rwPLUGIN_ERRENUM e_rwdb_CriterionGPVS
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionGPVSLAST
