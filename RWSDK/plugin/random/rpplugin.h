...
extern long rpRandomStackDepth;
#define RWDEBUGSTACKDEPTH rpRandomStackDepth
...
#define rwPLUGIN_ID      rwID_RANDOMPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionRandom
#define rwPLUGIN_ERRENUM e_rwdb_CriterionRandom
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionRandomLAST
