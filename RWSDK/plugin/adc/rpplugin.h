...
extern long rpADCStackDepth;

#define RWDEBUGSTACKDEPTH rpADCStackDepth
...
#define rwPLUGIN_ID             rwID_ADCPLUGIN
#define rwPLUGIN_ERRFUNC         _rwdb_CriterionADC
#define rwPLUGIN_ERRENUM        e_rwdb_CriterionADC
#define rwPLUGIN_ERRENUMLAST    e_rwdb_CriterionADCLAST
