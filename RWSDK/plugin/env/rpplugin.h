...
extern long rpEnvironmentStackDepth;
#define RWDEBUGSTACKDEPTH rpEnvironmentStackDepth
 ...
 * mechanism
 */
#define rwPLUGIN_ID      rwID_ENVIRONMENTPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionEnvironment
#define rwPLUGIN_ERRENUM e_rwdb_CriterionEnvironment
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionEnvironmentLAST
