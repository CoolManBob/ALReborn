...
extern long rpMatFXStackDepth;
#define RWDEBUGSTACKDEPTH rpMatFXStackDepth
...
#define rwPLUGIN_ID      rwID_MATERIALEFFECTSPLUGIN
#define rwPLUGIN_ERRFUNC _rwdb_CriterionMATERIALEFFECTS
#define rwPLUGIN_ERRENUM e_rwdb_CriterionMATERIALEFFECTS
#define rwPLUGIN_ERRENUMLAST e_rwdb_CriterionMATERIALEFFECTSLAST
